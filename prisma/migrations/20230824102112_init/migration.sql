...
-- AddForeignKey
ALTER TABLE "EmployeeCostField" ADD CONSTRAINT "EmployeeCostField_fieldId_fkey" FOREIGN KEY ("fieldId") REFERENCES "Field"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EmployeeCostValue" ADD CONSTRAINT "EmployeeCostValue_employeeFieldId_fkey" FOREIGN KEY ("employeeFieldId") REFERENCES "EmployeeCostField"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SplitTimeActivities" ADD CONSTRAINT "SplitTimeActivities_timeActivityId_fkey" FOREIGN KEY ("timeActivityId") REFERENCES "TimeActivities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
