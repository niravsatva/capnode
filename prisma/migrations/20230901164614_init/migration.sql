...
CREATE TABLE "MonthYearTable" (
    ...
    CONSTRAINT "MonthYearTable_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MonthYearTable_month_year_companyId_key" ON "MonthYearTable"("month", "year", "companyId");
...
-- AddForeignKey
ALTER TABLE "MonthYearTable" ADD CONSTRAINT "MonthYearTable_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
